import { findDonutWithMostSugar, findDonutWithMostIron, findDonutWithMostProtein, findDonutsWithLeastFiber } from "./hechizo1.js";
import { listAllDonutsWithCalories, listAllDonutsWithCarbohydrates, calculateAverageCalories, calculateTotalSaturatedFat, calculateAverageVitaminPercentages } from "./hechizo2.js";
import { listDonutBatters, listDonutToppings } from "./hechizo3.js";
import { calculateDonutsAndChange } from "./hechizo4.js";
import { modifyTransFatForHighCholesterolDonuts } from "./hechizo5.js";
...
const fetchAndProcessDonuts = async () => {
    try {
        ...
        //     console.log("Donut:", element.name);
        //     console.log("aaa")
        //     //console.log(transFatBeforeChange)
